# ডার্টে Generics-এ দক্ষতা অর্জন: যখন এক মাপ সবার জন্য যথেষ্ট নয়

তুমি কি কখনো নিজেকে একই কোড ব্লক বারবার কপি-পেস্ট করতে দেখেছ, শুধু ডেটার টাইপ পরিবর্তন করে? আমরা সবাই এমন পরিস্থিতির সম্মুখীন হয়েছি। পরিচিত হও Ppt-এর সাথে—একজন ডেভেলপার, যিনি ChatGPT ব্যবহার করেন কোডিং-এ সাহায্যের জন্য, কিন্তু এখনো নিজেকে বারবার একই ধরনের কোড লেখার ফাঁদে আটকে পান। তিনি এমন একটি data processing অ্যাপ্লিকেশন তৈরি করছেন, যেটিকে বিভিন্ন ধরণের ডেটা—user profile, product information, API response এবং cached data—handle করতে হবে।

"এটা আসলেই এখন বিরক্তিকর হয়ে গেছে," Ppt গজগজ করতে করতে ChatGPT-কে আরেকটা প্রায় একই রকম class বানাতে বলেন। "এর চেয়ে ভালো কোনো উপায় নিশ্চয়ই আছে!"

হ্যাঁ, সত্যিই আছে। সেটি হলো Generics। Generics কীভাবে Ppt-এর কোডকে রূপান্তর করেছে, আর কীভাবে তোমারটাকেও করতে পারে—চল দেখে নেওয়া যাক।
...
## Generic Classes: একটি ক্লাসই যথেষ্ট
...
১. **Type Safety (টাইপ নিরাপত্তা)**: "ভাবো তোমার অ্যাপ্লিকেশন রান করার আগেই টাইপ এরর ধরা পড়ছে," রাগিব বললেন। "Generics তোমাকে সেই ক্ষমতা দেয়। এগুলো নিশ্চিত করে যে তোমার কোড শক্তিশালী এবং নির্ভরযোগ্য, তোমাকে সেই ভয়াবহ রানটাইম ক্র্যাশ থেকে বাঁচায়।"

২. **Code Reusability (কোড পুনঃব্যবহারযোগ্যতা)**: "একই কোড বারবার লেখার দরকার কী যখন তুমি একবার লিখে সব জায়গায় ব্যবহার করতে পারো?" রাগিব জিজ্ঞাসা করলেন। "Generics তোমাকে টাইপ প্যারামিটারাইজ করতে দেয়, তোমার কোডকে একটি নমনীয়, পুনঃব্যবহারযোগ্য মাস্টারপিসে পরিণত করে।"
